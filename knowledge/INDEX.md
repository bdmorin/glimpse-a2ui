...
- [r2-shadcn-renderer Fork](20260510-110000.r2-shadcn-renderer-fork.analysis.md) — why we forked the renderer off the vendored Lit IIFE onto a Vite + React + Tailwind + shadcn stack on branch `r2-shadcn-renderer`. Architecture, bridge contract preservation, alternatives weighed, what's not done. **Read before iterating in the `glimpse-a2ui-shadcn` worktree.**
